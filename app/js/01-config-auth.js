...
function getSupabaseConfig(){
  const PROD={url:'https://nvojtsmurbvpclwcwrca.supabase.co',key:'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im52b2p0c211cmJ2cGNsd2N3cmNhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODE1OTYxODgsImV4cCI6MjA5NzE3MjE4OH0.83E5nAY27tX15ClrqwxjmAsPXj3Wx5na9j3Lg24I63E'};
  try{ const s=JSON.parse(localStorage.getItem(CFG_KEY)||'null'); if(s&&s.url&&s.key)return s; }catch{}
  return PROD;
}
...
function initSupabase(){
  ...
  const s=document.getElementById('setup-screen'); if(s)s.style.display='none';
  return true;
}
...
async function afterAuth(){
  ...
  if(window.__blankGuard){clearTimeout(window.__blankGuard);window.__blankGuard=null;}
